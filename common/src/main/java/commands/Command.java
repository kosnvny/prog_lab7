...
public abstract class Command implements Serializable {
    ...
    public abstract Response execute(Request request) throws ForcedExit, IllegalArguments, RecursionInScriptException, CommandDoesNotExist, InvalideForm, LessRoleThanNeedException;
